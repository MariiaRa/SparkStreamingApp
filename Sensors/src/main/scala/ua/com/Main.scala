...
object Main extends App {
  ...
  val params = Map("T" -> Temperature, "E" -> Emission, "H" -> Humidity)

  private def createActor(deviceID: String, value: Parameters): ActorRef = {
    system.actorOf(Sensor.props(deviceID, value), "Actor" + deviceID)
  }

  override def main(args: Array[String]): Unit = {

    params.foreach { case (key, value) => createActor(key, value) ! Start }
